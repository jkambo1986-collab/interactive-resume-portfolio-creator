...
const ResumeUploaderComponent: React.FC<ResumeUploaderProps> = ({ onUpload }) => {
    ...
    return (
        <div
            className={`relative p-6 border-2 border-dashed rounded-lg transition-all duration-200 cursor-pointer overflow-hidden ${dragActive ? 'border-sky-500 bg-sky-50' : 'border-slate-300 hover:border-slate-400 bg-white'
